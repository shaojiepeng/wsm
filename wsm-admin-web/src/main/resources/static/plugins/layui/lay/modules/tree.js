...
layui.define("jquery", function(e) {
    ...
    var o = layui.jquery,
        ...
        i.prototype.traverseModel = function(treeTable, parentNode, item, childrenAttrs) {
            ...
            tableHeaderStr += (i.checkbox == true ? '<th style="width:10px"><input type="checkbox" name="treeGirdCheckbox" lay-skin="primary" lay-filter="allChoose"></th>' : '<th style="width:10px"></th>');
